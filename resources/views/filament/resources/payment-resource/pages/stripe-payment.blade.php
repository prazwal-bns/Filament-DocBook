    ...
    <div class="grid flex-1 auto-cols-fr gap-y-10" >
            <div class="p-6 bg-white rounded-lg shadow-md">
                <form action="{{ route('stripe.post') }}" method="POST" id="payment-form">
                    ...
                    <!-- Card Details -->
                    <div class="mb-6">
                        <label for="card-element" class="block text-xl font-medium text-gray-700 mb-3">Card Details</label>
                    ...
                    <div class="flex justify-center">
                        <button type="submit"
                            class="w-full max-w-md py-3 px-6 bg-primary-600 text-white font-semibold rounded-lg shadow-md hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-400 focus:ring-opacity-50">
                            Submit Payment
                        </button>
                    </div>
                </form>
